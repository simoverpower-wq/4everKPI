...
function bindDayActions(){
  ...
  qsa('[data-dt]').forEach(function(btn){bindDeleteTaskBtn(btn);});
...
async function confirmDeleteTask(){
  ...
  closeDeleteModal();closeDrill();if(el('dd'))el('dd').classList.remove('open');await load();
}
